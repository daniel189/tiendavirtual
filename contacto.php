...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="index.php" style="width:138px;height:37px;line-height:71px;"> <img src="glyphicons/png/casa.png" alt=""/>INICIO</a></li>
	<li class="topmenu"><a href="#" style="width:163px;height:37px;line-height:71px;"><span> <img src="glyphicons/png/paquete.png" alt=""/>PRODUCTOS</span></a>
	<ul>
    <?php
	...
	<li class="topmenu"><a class="pressed" href="contacto.php" style="width:155px;height:37px;line-height:71px;"> <img src="glyphicons/png/llamada.png" alt=""/>CONTACTO</a></li>
	<li class="topmenu"><a href="clientes/form_registro_clientes.php" style="height:37px;line-height:71px;"> <img src="glyphicons/png/hombre.png" alt=""/>REGISTRARSE</a>
    </li>
</ul>
