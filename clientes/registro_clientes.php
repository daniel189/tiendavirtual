...
mysqli_query($conexion,"INSERT INTO codigos(codigo,fecha_antigua,id_cliente) VALUES ('$codigo','$fecha','$fila2[id_cliente]')");
    ...
    $mensaje = '<html>'.
		...
		'Para verificar su cuenta haga click en el siguiente enlace <a href="http://localhost/tienda/clientes/validar.php?codigo='.$codigo.'&id_cliente='.$fila2['id_cliente'].'">Click aquí</a>'.
    	'</body>'.
    	'</html>';
