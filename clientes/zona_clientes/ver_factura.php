...
if(isset($_SESSION["id_cliente"]) && isset($_GET["pedido"])){
	...
	$pdf->Cell(0,26,"Multimegaser.",0,0,"L");
	...
	$aux=$fila2["total_pedido"]-$fila2["total_pedido"]/1.12;

	$pdf->Cell(450,20,"I.V.A. 12%:",0,0,"R");
	$pdf->Cell(80,20,$aux." $",0,1,"L");

	$pdf->Cell(450,20,"TOTAL:",0,0,"R");
	$pdf->Cell(80,20,(($fila2["total_pedido"])+$aux)." $",0,0,"L");
