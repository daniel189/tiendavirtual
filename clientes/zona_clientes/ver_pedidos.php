		...
		$fila3=mysqli_fetch_array($registros3);
			...
			<?php
				...
				echo "<div style='float:right'>";
					...
					echo $fila3["total_pedido"]." dolares (Sin IVA)</br>";
					echo "--------------------------------------------</br>";
					echo "+ 12% de IVA</br>";
					echo "--------------------------------------------</br>";
					$aux_iva=$fila3["total_pedido"]/1.12;
					$aux_iva=round($aux_iva * 100)/100;
					$aux_iva=$fila3["total_pedido"]-$aux_iva;
					$total_iva=$fila3["total_pedido"]+$aux_iva;

					echo "Total: ".$total_iva." dolares";
