...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="index.php" style="width:172px;height:71px;line-height:71px;"> <img src="glyphicons/png/casa.png" alt=""/>INICIO</a></li>
	<li class="topmenu"><a class="pressed" href="#" style="width:197px;height:71px;line-height:71px;"><span> <img src="glyphicons/png/paquete.png" alt=""/>PRODUCTOS</span></a>
	<ul>
    <?php
...
<footer style="margin-top:-10px" class="wow bounceInDown" data-wow-duration="1.5s"><p>Todos los derechos reservados Daniel Ortega Henry Suntaxi David Palacios</p></footer>
