...
<ul id="css3menu1" class="topmenu">
    ...
    <a class="pressed" href="#" style="width:172px;height:71px;line-height:71px;">    <img src="glyphicons/png/casa.png" alt=""/>INICIO</a>

  </li>
	<li class="topmenu"><a href="#" style="width:197px;height:71px;line-height:71px;"><span><img src="glyphicons/png/paquete.png" alt=""/>PRODUCTOS</span></a>
	<ul>
    <?php
	...
	<li class="topmenu"><a href="contacto.php" style="width:189px;height:71px;line-height:71px;"><img src="glyphicons/png/llamada.png" alt=""/>CONTACTO</a></li>
	<li class="topmenu"><a href="#" style="height:71px;line-height:71px;"><img src="glyphicons/png/hombre.png" alt=""/>REGISTRO / ACCESO</a>
    	<ul>
...
<div class="slider wow bounceInUp" data-wow-duration="1.5s">
    ...
    <iframe src="header/wowslider.html" style="width:1920px;height:333px;max-width:100%;overflow:hidden;border:none;padding:0;margin:0 auto;display:block;" marginheight="0" marginwidth="0"></iframe>
...
<footer class="" data-wow-duration="1.5s"><p>Derechos Reservados © Daniel Ortega  David Palacios Henry Suntaxi</p></footer>
